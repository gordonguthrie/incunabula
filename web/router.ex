defmodule Incunabula.Router do
  ...
  scope "/", Incunabula do
    ...
    delete "/books/:slug/chaffs/:chaffslug",                  ChaffController,    :delete
    ...
    delete "/books/:slug/reviews/:reviewslug",                ReviewController,   :delete
    ...
    delete "/books/:slug/chapters/:chapterslug",              ChapterController,  :delete
    ...
    get    "/books/:slug/reviews/:reviewslug/tag/:tag",       ReviewController,   :show_tag
